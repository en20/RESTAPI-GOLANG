          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                Uma plataforma colaborativa para compartilhamento de
                conhecimento entre estudantes de Computação da UFC
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-gray-600">
                Projeto de código aberto, desenvolvido com tecnologias modernas
                e contribuições da comunidade acadêmica.
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            >
              <FaGithub style={{ color: "#2563EB", fontSize: "1.5rem" }} />
